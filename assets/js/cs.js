...
var option_overlay_skin = "black",
    ...
    option_hero_background_mode = "kenburns",
    ...
    option_hero_background_youtube_url = "https://www.youtube.com/watch?v=sjsskdk",
...
function getUrlParameter(e) {
    var a, o, t = decodeURIComponent(window.location.search.substring(1)),
        s = t.split("&");
    for (o = 0; o < s.length; o++)
        if (a = s[o].split("="), a[0] === e) return void 0 === a[1] ? !0 : a[1]
}
...
if ($(document).ready(function() {
        ...
        function e(e, a, o, t) {
            function s() {
                y.children().css("transition", "all 1000ms 500ms"), g.addClass("overlay-active"), g.removeClass("show"), g.find("div.controls").removeClass("show"), $("#cycle").cycle("pause")
            }

            function n() {
                y.children().css("transition", "all 800ms 200ms"), g.removeClass("overlay-active"), g.addClass("show"), "youtube" === option_hero_background_mode && setTimeout(function() {
            ...
            function i() {
                return _ == C || blockProcess === !0 ? !1 : (blockProcess = !0, 0 === _ && (s(), setTimeout(function() {
                    v.addClass("open")
                }, 200)), 0 == p ? _ += 1 : (_ = f, p = !1), m.removeClass("active"), u = m.eq(_ - 1), $(".social-icons li a").tooltip("hide"), void setTimeout(function() {
                    u.addClass("active"), l(), setTimeout(function() {
                        h.addClass("active"), setTimeout(function() {
                            blockProcess = !1
                        }, 800)
                    }, 400)
                }, 1e3))
            ...
            function r() {
                return 0 === _ || blockProcess === !0 ? !1 : (blockProcess = !0, 0 == p ? _ -= 1 : (_ = f, p = !1), m.removeClass("active"), u = m.eq(_ - 1), setTimeout(function() {
                    u.addClass("active"), l(), setTimeout(function() {
                        blockProcess = !1
                    }, 800)
                }, 800), void(0 === _ && (h.removeClass("active"), setTimeout(function() {
                    n(), v.removeClass("open")
                }, 800))))
            }

            function l() {
                "on" !== option_overlay_bullet_navigation || $(".hero").hasClass("error-404") || ($(".grcs_bullet_nav .nav_dots").removeClass("active"), $(".grcs_bullet_nav .nav_dots").eq(_).addClass("active"))
            }

            function c() {
                $(".grcs_bullet_nav .nav_dots").click(function() {
                    f = $(".grcs_bullet_nav .nav_dots").index(this), f != _ && (_ > f ? (p = !0, r()) : (p = !0, i()))
                })
            }
            ...
            var u, v = $(e),
                ...
                C = m.length,
                _ = 0;
            switch ("on" !== option_overlay_bullet_navigation || $(".hero").hasClass("error-404") || d(), b.click(function() {
                i()
            }), h.click(function() {
                r()
        ...
        e("#overlay", "section.overlay", "#hero .front-content", "#hero .front-content .container-mid"), $(".subscribe-form").submit(function() {
            ...
            return $.ajax({
                ...
                dataType: "json",
                success: function(e) {
                    0 === e.valid ? ($(".subscribe-form").addClass("error"), $(".subscribe-form input").attr("placeholder", e.message), $(".subscribe-form input").val("")) : ($(".subscribe-form input,.subscribe-form button").val("").prop("disabled", !0), $(".subscribe-form input").attr("placeholder", e.message), $(".subscribe-form").removeClass("error").addClass("success"))
                }
            }), !1
